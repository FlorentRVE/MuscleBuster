  ...
  return (
    <div className="flex justify-center items-center gap-16 p-10 my-10">
      ...
      <div className="flex flex-col justify-center items-center gap-5">
        ...
        <button className="bg-blue-800 text-white font-bold p-2 rounded-2xl w-[40%]">Acheter</button>
      ...
      <div className="flex flex-col justify-center items-center gap-5">
        ...
        <p className="font-bold text-xl">Nom du produit</p>
        <button className="bg-orange-400 text-white font-bold p-2 rounded-2xl w-[40%]">Acheter</button>
        <p className="">Description du produit</p>
      </div>
